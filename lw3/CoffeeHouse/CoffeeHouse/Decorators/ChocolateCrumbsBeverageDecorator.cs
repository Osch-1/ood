...
{
    public class ChocolateCrumbsBeverageDecorator : AbstractBeverageDecorator
    {
        private const int _costPerGramm = 2;
        private readonly int _mass;

        public ChocolateCrumbsBeverageDecorator( IBeverage beverage, int mass )
            : base( beverage )
        {
            if ( mass < 0 )
